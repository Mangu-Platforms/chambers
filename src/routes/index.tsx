  ...
  return (
    <div className="min-h-screen bg-paper">
      ...
      <main id="main">
          ...
          <div className="mx-auto grid max-w-page items-start gap-16 lg:grid-cols-[0.92fr_1.08fr]">
            <div>
              ...
              <p className="mt-6 max-w-md text-base leading-relaxed text-soft">
                Paste what you have. We put it on letter paper, tailor it to the posting, and never invent a fact.
              </p>
        ...
        <section className="border-t border-hair px-5 py-20 md:px-8">
          <div className="mx-auto grid max-w-page gap-12 md:grid-cols-3">
            {[
              { n: "01", title: "Import", body: "Paste a messy file. Identity, roles, bullets, and skills land on paper in seconds." },
              { n: "02", title: "Tailor", body: "One posting. One honest version. Missing keywords stay listed — never fabricated." },
              { n: "03", title: "Print", body: "Letter-width sheet, print stylesheet, PDF from the browser. Same voice for the cover letter." },
            ].map((s) => (
              <div key={s.n}>
            ...
            <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {TEMPLATES.map((t) => (
                <Link
                  key={t.id}
                  to="/templates"
                  className="rounded-lg border border-hair bg-paper p-3 hover:border-hair-strong hover:shadow-pop"
                >
        ...
        <section className="border-t border-hair px-5 py-20 md:px-8">
          <div className="mx-auto max-w-page">
            <h2 className="font-serif max-w-xl text-3xl font-medium tracking-[-0.03em] md:text-4xl">
              No subscription. No watermark. No invented jobs.
            </h2>
            <p className="mt-4 max-w-lg text-body leading-relaxed text-soft">
              Private by default. Stored in this browser, not on a server. Instant ATS match against the posting you paste.
            </p>
            <div className="mt-8">
              <Button asChild size="lg">
                <Link to="/start">
